...
assert.match(filtersSource, /institution-filter-reset/);
assert.match(filtersSource, /Admissions rate:/);
assert.match(filtersSource, /percentage points/);
assert.match(filtersSource, /Recruitment composition/);
assert.match(filtersSource, /firstTimeHomeStateCount/);
assert.match(filtersSource, /firstTimeOtherStateCount/);
assert.match(filtersSource, /firstTimeForeignCountryCount/);
assert.match(filtersSource, /firstTimeUnknownResidenceCount/);
assert.match(filtersSource, /residenceSourceYear/);
assert.match(filtersSource, /EnrollmentDiagnosticsCore\.institutionMapGrouping\(metric, values\)/, 'institution map must use grouped metric bands');
...
assert.match(filtersSource, /DATA\.map_meta\?\.extent/, 'institution explorer must wait for the shared map extent before rendering');
